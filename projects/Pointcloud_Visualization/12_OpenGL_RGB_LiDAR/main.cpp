...
int main()
{
    ...
    shaderProgram_white->createShaderFromFile(GL_VERTEX_SHADER,   "model_view_projection.vs");
    shaderProgram_white->createShaderFromFile(GL_FRAGMENT_SHADER, "white.fs");
    shaderProgram_white->attachAndLinkShaders();

    shared_ptr<ShaderProgram> shaderProgram_color = make_shared<ShaderProgram>();
    shaderProgram_color->createShaderFromFile(GL_VERTEX_SHADER,   "model_view_projection.vs");
    shaderProgram_color->createShaderFromFile(GL_FRAGMENT_SHADER, "projection_color.fs");
    shaderProgram_color->attachAndLinkShaders();
